...
export function ShopView({
  ...
  return (
    <div className="w-full">
      ...
      {isHomepage && (
        <div className="relative w-full h-[85vh] overflow-hidden border-b border-ink/10 mb-6 bg-ink/5 -mt-[102px] md:-mt-[106px]">
          <img
            src="/hero-streetwear.png"
            alt="Out of Office Streetwear Collection"
            className="w-full h-full object-cover object-[center_32%] opacity-90 transition-transform duration-10000 ease-out hover:scale-105"
          />
